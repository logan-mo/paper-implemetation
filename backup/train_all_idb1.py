...
dataset = ALL_IDB2(os.path.join('data', 'ALL_IDB1', 't_aug'), transform1=transforms1, transform2=transforms2)
...
while(epoch < n_epochs):
    ...
    validation_loss = test(epoch,'final_train_allidb1') / len(test_dataloader)
    scheduler.step()
    epoch+=1